const orbits = {
    ...
    createOrbit(body) {
        ...
        let orbitMaterial = new THREE.LineDashedMaterial({ //zimet ka dash, eksistee ar lightmatirial
            color: 0xfa00ff, linewidth: 1,
            scale: 0.4,
            dashSize: 3000,
            gapSize: 3000,
        });
        body.orbitGeometry = new THREE.BufferGeometry(); //vari ari izmanto geometryObject, bet tas ir lenak
